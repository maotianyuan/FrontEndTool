      ...
      <div class="container-fluid scroll-bar">
        <div class="panel panel-default">
          <div class="panel-body">
            <h3>命令行命令</h3>
            <p>1：gulp .example-guide-all</p>
            <h3>package 配置快捷命令</h3>
            <p>scripts{ <br>  '.example':'gulp .example-guide-all'  <br>  '+example':'gulp +example-guide-all' <br>}</p>
            <p>2：gulp +example-guide-all</p>
            <p>3：gulp example-guide-pug 当公共aside等更改时，需要将所有html更新一遍，所有需要对所有pug进行打包</p>
            <p>4：gulp example-guide-less 对公共资源进行打包</p>
          </div>
        </div>
      </div>
    </div>
