...
<html lang="en-us">
  <head>
    ...
    <link href="/guide/css/home/index.css?_=20180809" rel="stylesheet">
    <meta name="example-data" content="{{php_data}}">
  </head>
  <body>
    ...
    <footer class="bmw-footer">
      <div class="f-content"><span style="color: #8e96a5;font-size: 13px;cursor: default;margin-right: 8px;">
           Copyright©<span id="footerYear"></span>光速斑马数据科技有限公司，All Rights Reserved</span><a href="http://www.miitbeian.gov.cn" target="_blank" style="color: #8e96a5;font-size: 13px;cursor: pointer">京ICP备17036596号-1</a></div>
    </footer>
    <script>
    ...
    <script src="/guide/js/home/index.min.js?_=20180809" type="text/javascript"></script>
