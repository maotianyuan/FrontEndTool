...
<html lang="en-us">
  <head>
    ...
    <link href="/guide/css/echarts/shell/index.css?_=20180809" rel="stylesheet">
  </head>
  <body>
    ...
    <div class="bmw-main-container scroll-bar">
      <div class="container-fluid scroll-bar">
        <div class="bmw-title"><span class="title">图库 </span></div>
        <div class="seciton-wrap">
          <div class="section-split section-left">
            <div class="echart-wrap">
              <div class="echart-shell" id="lineBar_1"></div>
            </div>
          </div>
          <div class="section-split section-right"></div>
        </div>
      </div>
    </div>
    <script>
    ...
    <script src="/lib/widget/echarts/echarts.min.js?_=20180809" type="text/javascript"></script>
    <script src="/guide/js/echarts/shell/index.min.js?_=20180809" type="text/javascript"></script>
